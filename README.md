# Polderpijplijn — Support

Support en feedback voor de [Polderpijplijn](https://www.polderpijplijn.nl)-apps
(Grim Reader, Thuis, …).

**Support and feedback for the Polderpijplijn apps.**
...
_Dit repo bevat geen app-code, alleen support-content (issue-formulieren en
kennisbank-bronnen)._
